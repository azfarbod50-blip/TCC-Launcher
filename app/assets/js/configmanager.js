...
exports.getClientModsConfig = function(serverId){
    return config.clientMods[serverId] || {}
}

exports.setClientModEnabled = function(serverId, modKey, enabled){
    if(config.clientMods[serverId] == null){
        config.clientMods[serverId] = {}
    }
    config.clientMods[serverId][modKey] = enabled
}

exports.getOnlineFeatures = function(){
    return config.onlineFeatures !== false
}

exports.isOnlineFeaturesEnabled = function(){
    return config.onlineFeatures !== false
}

exports.setOnlineFeatures = function(enabled){
    config.onlineFeatures = enabled
}

exports.getClientMods = function(){
    return config.clientMods
}

exports.setClientMods = function(val){
    config.clientMods = val
}